...
$key = q/{lstlisting}[language=Python]classVM:{par{defld(self):'loadregister'#getregisterommandneedVM.prefixVM.ld,1,'R[1]',#R[1]<-'string'VM.nop,VM.bye]){lstlisting};AAT/;
$cached_env_img{$key} = q|<IMG
 WIDTH="567" HEIGHT="431" ALIGN="BOTTOM" BORDER="0"
 SRC="|."$dir".q|img6.png"
...
$key = q/{lstlisting}[language=Python]classVM:#programmemorysharedbetweenVMinstancesprogr=[0,1,2,3,4,5,6,7]#registerpoolifP:self.program=P#loadprogram...{lstlisting};AAT/;
$cached_env_img{$key} = q|<IMG
 WIDTH="567" HEIGHT="151" ALIGN="BOTTOM" BORDER="0"
 SRC="|."$dir".q|img5.png"
 ALT="\begin{lstlisting}[language=Python]
class VM:
...">|; 
