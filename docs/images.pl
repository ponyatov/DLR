...
$key = q/{lstlisting}[title=ypp.ypp:yaccsyntaxparser]{lstlisting};AAT/;
$cached_env_img{$key} = q|21#1|; 
...
$key = q/{lstlisting}[language=C++]voidnop(){printf("nop");}{lstlisting};AAT/;
$cached_env_img{$key} = q|24#3|; 

$key = q/{lstlisting}0000<unboundmethodVM.ld>[0,1,2,3,4,5,6,7]0003<unboundmethodVM.nop>[0[1]',2,3,4,5,6,7]0004<unboundmethodVM.bye>[0,'R[1]',2,3,4,5,6,7]{lstlisting};AAT/;
$cached_env_img{$key} = q|<IMG
 WIDTH="567" HEIGHT="64" ALIGN="BOTTOM" BORDER="0"
 SRC="|."$dir".q|img5.new"
...
$key = q/{lstlisting}<command><addr1><addr2><addr3>{lstlisting};AAT/;
$cached_env_img{$key} = q|<IMG
...
$key = q/{lstlisting}[language=C++]#defineopNOP0x00slashslashnop#defineopBYE0xFFslashslasdefineopRET0x04slashslashret#defineopLIT0x05slashslashlit<value>{lstlisting};AAT/;
$cached_env_img{$key} = q|22#2|; 
